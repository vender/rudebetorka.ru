...
$db = getDbInstance();
$select = array('id', 'name', 'text', 'atachments', 'created_at', 'updated_at');
...
$rows = $db->arraybuilder()->paginate('sender_templates', $page, $select);
...
<div id="page-wrapper" class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
            <h1 class="h2">Шаблоны писем</h1>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group me-2">
                <a href="sender/templates/add_template.php?operation=create" class="btn btn-success"><i class="bi bi-plus"></i> Добавить</a>
            </div>
        </div>
    </div>
        ...
        <tbody>
            <?php foreach ($rows as $row) : ?>
                <tr>
                    ...
                    <td>
                        <a href="sender/templates/edit_template.php?id=<?php echo $row['id']; ?>&operation=edit" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i></a>
    ...
    <div class="text-center">
        <?php echo paginationLinks($page, $total_pages, 'events/index.php'); ?>
    </div>
    <!-- //Pagination -->
</div>
<!-- //Main container -->
